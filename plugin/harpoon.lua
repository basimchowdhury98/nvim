...
map("n", "<C-m>", function() ui.nav_file(1) end, { desc = "Navigate to file 1" })
map("n", "<C-t>", function() ui.nav_file(2) end, { desc = "Navigate to file 2" })
map("n", "<C-r>", function() ui.nav_file(3) end, { desc = "Navigate to file 3" })
